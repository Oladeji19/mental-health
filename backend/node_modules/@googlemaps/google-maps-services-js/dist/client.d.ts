...
import { DistanceMatrixRequest, DistanceMatrixResponse } from "@googlemaps/google-maps-services-js/dist/distance";
import { ElevationRequest, ElevationResponse } from "@googlemaps/google-maps-services-js/dist/elevation";
import { FindPlaceFromTextRequest, FindPlaceFromTextResponse } from "@googlemaps/google-maps-services-js/dist/places/findplacefromtext";
import { GeocodeRequest, GeocodeResponse } from "@googlemaps/google-maps-services-js/dist/geocode/geocode";
import { GeolocateRequest, GeolocateResponse } from "@googlemaps/google-maps-services-js/dist/geolocate";
import { NearestRoadsRequest, NearestRoadsResponse } from "@googlemaps/google-maps-services-js/dist/roads/nearestroads";
import { PlaceAutocompleteRequest, PlaceAutocompleteResponse } from "@googlemaps/google-maps-services-js/dist/places/autocomplete";
import { PlaceDetailsRequest, PlaceDetailsResponse } from "@googlemaps/google-maps-services-js/dist/places/details";
import { PlacePhotoRequest, PlacePhotoResponse } from "@googlemaps/google-maps-services-js/dist/places/photo";
import { PlaceQueryAutocompleteRequest, PlaceQueryAutocompleteResponse } from "@googlemaps/google-maps-services-js/dist/places/queryautocomplete";
import { PlacesNearbyRequest, PlacesNearbyResponse } from "@googlemaps/google-maps-services-js/dist/places/placesnearby";
import { ReverseGeocodeRequest, ReverseGeocodeResponse } from "@googlemaps/google-maps-services-js/dist/geocode/reversegeocode";
import { SnapToRoadsRequest, SnapToRoadsResponse } from "@googlemaps/google-maps-services-js/dist/roads/snaptoroads";
import { TextSearchRequest, TextSearchResponse } from "@googlemaps/google-maps-services-js/dist/places/textsearch";
import { TimeZoneRequest, TimeZoneResponse } from "@googlemaps/google-maps-services-js/dist/timezone";
