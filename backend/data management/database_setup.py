...
def create_tables():
    ...
    try:
        ...
        # Create the listener table. When the listeners, registers they select their problem specialization, availability, language and experience level
        cursor.execute('''
        ...
        # Create the user table. This table stores the user's email, username and password
        cursor.execute('''
